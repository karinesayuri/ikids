...
@WebServlet("/InvestimentoRendaVariavel")
public class InvestimentoRendaVariavelController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		investimento.setTipoInvestimento("Renda Variável");
		investimento.setTaxaInvestimento(new BigDecimal(1.0));
